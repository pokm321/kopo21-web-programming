...
<html>
  ...
  <body>
    <h1>후보 별 득표율 (Dark ver.)</h1>
    <a href="UIReportAll.jsp" id="changeUI">일반모드</a>
    <table>
      <%
        ...
        for (int i = 0; i < tag_name.getLength(); i++) {
          ...
          out.println("<tr>");
          out.println("<td id='nametd'><a id='button2' href='UI2ReportOne.jsp?id=" + tag_id.item(i).getFirstChild().getNodeValue() + "'>" + tag_id.item(i).getFirstChild().getNodeValue() + " " + tag_name.item(i).getFirstChild().getNodeValue() + "</a></td>");
