...
<html>
  ...
  <body>
    <h1>후보 별 득표율</h1>
    <a href="UI2ReportAll.jsp" id="changeUI">다크모드</a>
    <table>
      <%
        ...
        for (int i = 0; i < tag_name.getLength(); i++) {
          ...
          out.println("<tr>");
          out.println("<td id='nametd'><a id='button2' href='UIReportOne.jsp?id=" + tag_id.item(i).getFirstChild().getNodeValue() + "'>" + tag_id.item(i).getFirstChild().getNodeValue() + " " + tag_name.item(i).getFirstChild().getNodeValue() + "</a></td>");
